...
Program2: Write a menu driven program in Java to perform insertion, deletion, linear search, binary 
search, to find maximum value, to count even/ odd and to perform insertion sort operation in 
one dimensional array. 

Program3: Write a program to perform addition, subtraction, multiplication, transpose, to check square 
matrix, to check matrix is diagonal, and to check matrix is identity. 

Program4: Differentiate String, StringBuffer and StringBuilder. Write a program to perform String 
...
Program5: Design a console-based Bank Management Program in Java that allows a user to create a 
